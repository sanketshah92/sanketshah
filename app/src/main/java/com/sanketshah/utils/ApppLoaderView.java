...
public class ApppLoaderView extends android.support.v7.widget.AppCompatImageView {
    ...
    public ApppLoaderView(Context context) {
        super(context);
        init(context, null);
    }

    public ApppLoaderView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ApppLoaderView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    public ApppLoaderView setCircleDuration(int circleDuration) {
        this.mCircleDuration = circleDuration;
        mCircleAnim.setDuration(mCircleDuration);
        return this;
    }

    public ApppLoaderView setRotateDuration(int rotateDuration) {
...
//            //Log.d(TAG, "onTouchEvent: " + event.getAction());
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        @SuppressLint("CustomViewStyleable") TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.InsLoadingViewAttr);
    ...
    private void initRectFs() {
        if (mBitmapRectF == null) {
            float bitmapDia = CIRCLE_DIA - STROKE_WIDTH;
